...
{
	int iConn;
	UDT::INetworkListener::enNetworkCode code;
	int param;
};
typedef std::list<connectNode>  T_listNode;
class NPeerMng
	:public UDT::INetworkListener,JThread
{
	T_listNode    m_listNode;
...
private:
	...
	virtual void OnConnectionMsgThread(int iConn,enNetworkCode code,int param);
